...
| File | Description |
| --- | --- |
| `vlsi_tech_certificate1.pdf` | VLSI Tech internship certificate 1 |
| `vlsi-tech_certificate2.pdf` | VLSI Tech internship certificate 2 |

## Certificates

- [VLSI Tech Certificate 1](vlsi_tech_certificate1.pdf)
- [VLSI Tech Certificate 2](vlsi-tech_certificate2.pdf)
